import { ContractPublicData, L2Block, L2Logs, INITIAL_L2_BLOCK_NUM, ContractData, L1ToL2Message } from '@aztec/types';
...
export interface ArchiverDataStore {
   ...
   * @returns True if the operation is successful.
   */
  addEncryptedLogs(data: L2Logs[]): Promise<boolean>;
...
export class MemoryArchiverStore implements ArchiverDataStore {
   ...
   * @returns True if the operation is successful (always in this implementation).
   */
  public addEncryptedLogs(data: L2Logs[]): Promise<boolean> {
